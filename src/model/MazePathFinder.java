...
public final class MazePathFinder {
         ...
         */
        private static boolean hasPath(final Room[][] theMaze, final Set<Room> vistedRooms,
                        final int[] current, final int[] end) {
         ...
         */
        private static Set<Room> markPresent(final Room[][] theMaze, final Set<Room> vistedRooms, final int[] current) {
                // deep copy so each one has a unique visited list
                //		final boolean[][] copy = new boolean[vistedRooms.length][vistedRooms[0].length];
